<section id="createaccount">
    ...
    <form id="signup" action="" method="post"> 
    	<dl>
    		...
    		<dd><input name="shop_name" type="text" required="required" size="30" label="Business Name" value="<?php echo htmlentities($shop_name) ?>"></dd>
    		...
    		<dd><input name="phone" type="tel" required="required" size="16" minlength="10" label="Phone Number" value="<?php echo htmlentities($phone) ?>"></dd>
